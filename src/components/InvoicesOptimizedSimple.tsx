...
export function InvoicesOptimized() {
  ...
  }, [customerName, mobile, items, totals, paidAmount, selectedCustomerId, invoiceDate, vatEnabled, notes, createInvoiceMutation]);
  ...
  const handleCustomerSelect = useCallback((customerId: string, customer: any) => {
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {Array.isArray(selectedInvoiceData.invoice_items) && 
                       selectedInvoiceData.invoice_items.map((item: any) => (
